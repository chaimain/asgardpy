...
`Gammapy documentation <https://docs.gammapy.org/1.3/user-guide/datasets/index.html#types-of-supported-datasets>`_
and are:
...
#. chi2
    ...
    `example <https://docs.gammapy.org/1.3/tutorials/analysis-3d/analysis_mwl.html#hawc-1d-dataset-for-flux-point-fitting>`_
...
`documentation <https://docs.gammapy.org/1.3/user-guide/stats/index.html>`_
