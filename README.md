...
## Analysis Software Package for GAmma-Ray Data in Python

'User-friendly' configuration-centred package built over [Gammapy](https://github.com/gammapy/gammapy) High Level Interface, to allow for easy simultaneous analysis of various datasets of different formats.
...
Follow the documentation at https://asgardpy.readthedocs.io/en/latest/ for the main functionality of this package.
...
The package was developed with first testing with Fermi-LAT ([enrico](https://enrico.readthedocs.io/en/latest/) and [fermipy](https://fermipy.readthedocs.io/en/latest/)) files and LST-1 ([cta-lstchain](https://cta-observatory.github.io/cta-lstchain/)) DL3 files (with energy-dependent and global directional cuts) for point-like sources.
...
Examples of usage of asgardpy is shown in jupyter notebooks in ``notebooks/`` but as there are no public test data included with the package yet, the results are empty.
...
Package generated based on the template by [python-package-template](https://github.com/allenai/python-package-template).
